...
import "@bookph/core/lib/server/__mocks__/serviceAccountKey";

import { describe, it, expect, beforeEach, vi } from "vitest";

import { CalendarAppDelegationCredentialInvalidGrantError } from "@bookph/core/lib/CalendarAppError";

import { handleCreateSelectedCalendars, isSameEmail } from "../route";

// Mock GoogleCalendarService
const getPrimaryCalendarMock = vi.fn();
vi.mock("@bookph/core/app-store/googlecalendar/lib/CalendarService", () => {
  return {
