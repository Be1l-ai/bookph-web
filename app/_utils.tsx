...
import { getLocale } from "@bookph/core/features/auth/lib/getLocale";
import type { AppImageProps, MeetingImageProps } from "@bookph/core/lib/OgImages";
import { constructAppImage, constructGenericImage, constructMeetingImage } from "@bookph/core/lib/OgImages";
import { IS_CALCOM, WEBAPP_URL, APP_NAME, SEO_IMG_OGIMG, CAL_URL } from "@bookph/core/lib/constants";
import { getCalcomUrl } from "@bookph/core/lib/getCalcomUrl";
import { buildCanonical } from "@bookph/core/lib/next-seo.config";
import { getTranslation } from "@bookph/core/lib/server/i18n";
import { truncateOnWord } from "@bookph/core/lib/text";
