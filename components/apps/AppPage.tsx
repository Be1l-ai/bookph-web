...
import { AppDependencyComponent } from "@bookph/core/app-store/AppDependencyComponent";
import { InstallAppButton } from "@bookph/core/app-store/InstallAppButton";
import { isRedirectApp } from "@bookph/core/app-store/_utils/redirectApps";
import useAddAppMutation from "@bookph/core/app-store/_utils/useAddAppMutation";
import { doesAppSupportTeamInstall, isConferencing } from "@bookph/core/app-store/utils";
import DisconnectIntegration from "@bookph/core/features/apps/components/DisconnectIntegration";
import { AppOnboardingSteps } from "@bookph/core/lib/apps/appOnboardingSteps";
import { getAppOnboardingUrl } from "@bookph/core/lib/apps/getAppOnboardingUrl";
import { APP_NAME, COMPANY_NAME, SUPPORT_MAIL_ADDRESS, WEBAPP_URL } from "@bookph/core/lib/constants";
import { useCompatSearchParams } from "@bookph/core/lib/hooks/useCompatSearchParams";
import { useLocale } from "@bookph/core/lib/hooks/useLocale";
import { trpc } from "@bookph/core/trpc/react";
import type { App as AppType } from "@bookph/core/types/App";
...
import { SkeletonButton, SkeletonText } from "@bookph/ui/components/skeleton";
