...
import AppNotInstalledMessage from "@bookph/core/app-store/_components/AppNotInstalledMessage";
import KeyField from "@bookph/core/app-store/btcpayserver/components/KeyInput";
import { btcpayCredentialKeysSchema } from "@bookph/core/app-store/btcpayserver/lib/btcpayCredentialKeysSchema";
import type { IBTCPaySetupProps } from "@bookph/core/app-store/btcpayserver/pages/setup/_getServerSideProps";
